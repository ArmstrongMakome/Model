...
# === 3. BALANCE DATA AND SPLIT INTO TRAINING AND TEST SETS (CRISP-DM: Data Preparation) ===
...
# Note: No explicit validation set with 80-20 split; validation handled by cv=5 internally
print("Note: Validation is handled internally via 5-fold cross-validation in StackingClassifier.")
